                        ...
                        <p className="md:text-base text-sm font-serif text-justify p-5 w-full lg:w-10/12" onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)}>
                            {
                                !hover
                                    ...
                                    <>
                                        ...
                                        ଅଙ୍ଗେ ନିଭା କଥା -କା ହା ଣୀ କୁ ବା ଣ୍ଟିବା ପା ଇଁ ପ୍ରୋ ତ୍ସା ହିତ କରେ । <br /><br />
                                        ...
                                        ମା ନଙ୍କରୁ ସଂ ଗୃହୀ ତ ତଥ୍ୟ ବା ସୂଚନା କୁ ପା ଥେ ୟ କରେ । <br /><br />
                                        ...
                                        ଉପଲବ୍ଧ ।<br /><br />
                                        ପାରିବାର୍ଟା ମହାନ୍ତି ଏବଂ ଗୀତା ନନ୍ଦନ ବଲାବା ଦାସଙ୍କ ପାଠ୍ୟ ଏବଂ ଅନୁବାଦ <br /><br />
