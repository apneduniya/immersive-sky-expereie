...
export default function TamarindSkyPage() {
	...
	return (
		<>
			<ContextMenu>
				<main className="min-h-dvh w-full px-10 flex items-center justify-between bg-img-bg-5 bg-cover bg-center" onMouseEnter={() => setSectionHover(true)} onMouseLeave={() => setSectionHover(false)}>
					...
					<div className="relative flex items-center justify-center flex-col gap-20">
						...
						<p className="lg:absolute lg:w-[740px] lg:-right-64 lg:-bottom-20 w-full text-center cursor-default 2xl:text-2xl xl:text-2xl lg:text-2xl md:text-xl text-lg" onMouseEnter={() => setTextHover(true)} onMouseLeave={() => setTextHover(false)}>
							{
